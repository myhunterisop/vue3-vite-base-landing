    ...
    <footer class="footer">
        <div class="container">
            <div class="footer__wrapper">
                <div class="footer__item">© 2018 «LoremIpsum.net» Все права защищены.</div>
                <div class="footer__item payments">
                    <div class="payments__item payments__item--qiwi">Qiwi wallet</div>
                    <div class="payments__item payments__item--yandex">Yandex Money</div>
                    <div class="payments__item payments__item--webmoney">Web Money</div>
                </div>
                <div class="footer__item contacts">
                    <a
                        href="mailto:info@ipsum228.com"
                        class="contacts__item contacts__item--mail link"
                    >info@ipsum228.com</a>
                    <a
                        href="https://vk.com/"
                        target="_blank"
                        class="contacts__item contacts__item--vk link"
                    >Мы вконтакте</a>
                </div>
            </div>
        </div>
